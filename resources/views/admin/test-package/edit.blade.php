...
@section('title', __('Edit Test Package'))

@section('admin-content')
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>{{ __('Edit Test Package') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></div>
                <div class="breadcrumb-item">{{ __('Edit Test Package') }}</div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center w-100">
                                <h3 class="card-title">{{ __('Edit Test Package') }}</h3>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.test-package.update', $testPackage) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-8">
                                            ...
                                            <select class="form-select @error('category_id') is-invalid @enderror" 
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{ $category->id }}" 
                                                            {{ old('category_id', $testPackage->category_id) == $category->id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                id="name" name="name" value="{{ old('name', $testPackage->name) }}" required>
                                            @error('name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                    id="description" name="description" rows="4">{{ old('description', $testPackage->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror" 
                                                ...
                                                value="{{ old('duration_minutes', $testPackage->duration_minutes) }}" min="1" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('passing_score') is-invalid @enderror" 
                                                ...
                                                value="{{ old('passing_score', $testPackage->passing_score) }}" min="0" max="100" required>
                                            @error('passing_score')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                    ...
                                                    value="1" {{ old('show_score_to_user', $testPackage->show_score_to_user) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                    ...
                                                    value="1" {{ old('is_applicant_flow', $testPackage->is_applicant_flow) ? 'checked' : '' }}
                                        ...
                                        <div id="applicant-flow-fields" style="display: {{ old('is_applicant_flow', $testPackage->is_applicant_flow) ? 'block' : 'none' }}">
                                            <div class="mb-3">
                                                <label for="is_screening_test" class="form-label">{{ __('Test Type') }}</label>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                        id="is_screening_test" name="is_screening_test" 
                                                        value="1" {{ old('is_screening_test', $testPackage->is_screening_test) ? 'checked' : '' }}
                                            ...
                                            <div id="flow-order-field" style="display: {{ old('is_screening_test', $testPackage->is_screening_test) ? 'none' : 'block' }}">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('applicant_flow_order') is-invalid @enderror" 
                                                        ...
                                                        value="{{ old('applicant_flow_order', $testPackage->applicant_flow_order) }}" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('is_active') is-invalid @enderror" 
                                                ...
                                                <option value="1" {{ old('is_active', $testPackage->is_active) == 1 ? 'selected' : '' }}>
                                                    {{ __('Active') }}
                                                </option>
                                                <option value="0" {{ old('is_active', $testPackage->is_active) == 0 ? 'selected' : '' }}>
                                                    {{ __('Inactive') }}
                                                </option>
                                            </select>
                                            @error('is_active')
