                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <x-admin.form-input id="link"  name="link" label="{{ __('Link') }}" placeholder="{{ __('Enter link') }}" value="{{ old('link') }}" required="true"/>
                                            </div>
                                        </div>

                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <x-admin.form-image-preview label="{{__('Icon')}}" button_label="{{__('Icon')}}" name="icon" required="true"/>
                                            </div>
                                        </div>
