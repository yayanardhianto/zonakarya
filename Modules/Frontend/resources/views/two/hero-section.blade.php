...
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('Hero Section') }}" :list="[
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.hero-section.update', ['code' => $code]) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <x-admin.form-input id="title_three" data-translate="true" name="title_three"
                                                    label="{{ __('Title Part three') }}"
                                                    placeholder="{{ __('Enter Title Part three') }}"
                                                    value="{{ $heroSection?->getTranslation($code)?->content?->title_three }}" required="true" />
                                            </div>
                                        </div>
